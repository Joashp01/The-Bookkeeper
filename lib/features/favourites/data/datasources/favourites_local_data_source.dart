...
/// Interface for local favourites persistence. The repository depends on this
/// abstraction, so tests substitute an in-memory (ffi) database at the same
/// seam without any change to the layers above.
